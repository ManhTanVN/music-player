...
//     allMusics.forEach(function(music, index) {
//         let html = `
//             <li>
//                 <div class="row">
...
//                     <p>${music.artist}</p>
//                 </div>
//                 <audio class="no-${index}" src="${music.src}"></audio>
//                 <div id="no-${index}" class="audio-duration">3:50</div>
//             </li>
        
//         `
//         songListBar.insertAdjacentHTML("beforeend", html.join(''))
//         // let getDuration = document.querySelector(`.no-${index}`) 
//         // let addDuraion = document.querySelector(`#no-${index}`)
//         // console.log(getDuration, addDuraion)
//     })
...
for(let i = 0; i <= allMusics.length; i++) {
    let html = `
            <li>
                <div class="row">
                    <span>${this.allMusics[i].name}</span>
                    <p>${this.allMusics[i].artist}</p>
                </div>
                <audio class="no-${i}" src="${this.allMusics[i].src}"></audio>
