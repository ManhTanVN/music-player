...
function loadMusics(indexNumb) {
    ...
    musicName.textContent = allMusics[indexNumb].name
    musicArtist.textContent = allMusics[indexNumb].artist
    mainAudio.src = allMusics[indexNumb].src
}

// prgress bar
function progressTime() {
    mainAudio.addEventListener('change', () => {
        const currentTimeOfSong = mainAudio.currentTime()
