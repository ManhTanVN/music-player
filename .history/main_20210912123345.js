...
function loadSongList() {
    let html = allMusics.map(function(music, index) {
        return `
            <li>
                <div class="row">
    ...
    let getDuration = document.querySelector(`.wrapper .music-list .no-${index}`) 
    let addDuraion = document.querySelector(`.wrapper .music-list #no-${index}`)
